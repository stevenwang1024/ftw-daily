...
export const TRANSITION_PAY = 'transition/pay';
...
export const TRANSITION_PROVIDER_ACCEPT= 'transition/provider-accept';
...
export const TRANSITION_CUSTOMER_ACCEPT = 'transition/customer-accept';
...
const STATE_PENDING_CUSTOMER = 'pending-customer';
const STATE_PROVIDER_MADE_OFFER = 'customer-made-offer';
...
const stateDescription = {
  ...
  id: 'negotiated-nightly-booking/release-1',
  ...
  states: {
    [STATE_INITIAL]: {
      on: {
        ...
        [TRANSITION_REQUEST]: STATE_CUSTOMER_MADE_OFFER,
      },
    },
    [STATE_ENQUIRY]: {
      on: {
        [TRANSITION_REQUEST_AFTER_ENQUIRY]: STATE_CUSTOMER_MADE_OFFER,
      },
    },

    [STATE_CUSTOMER_MADE_OFFER]: {
      on: {
        [TRANSITION_PROVIDER_ACCEPT]: STATE_PENDING_CUSTOMER,
    ...
    [STATE_PROVIDER_MADE_OFFER]: {
      on: {
        [TRANSITION_CUSTOMER_ACCEPT]: STATE_PENDING_PAYMENT,
    ...
    [STATE_PENDING_CUSTOMER]: {
      on: {
        [TRANSITION_PAY]: STATE_PENDING_PAYMENT,
...
export const transitionsToRequested = [...getTransitionsToState(STATE_CUSTOMER_MADE_OFFER)];
...
export const txIsProviderMadeOffer = tx =>
  getTransitionsToState(STATE_PROVIDER_MADE_OFFER).includes(txLastTransition(tx));

export const xxIsPendingCustomer = tx => 
  getTransitionsToState(STATE_PENDING_CUSTOMER).includes(txLastTransition(tx));
